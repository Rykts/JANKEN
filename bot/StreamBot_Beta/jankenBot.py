...
wb = Workbook()
ws = wb.active
df = pd.read_csv('C:/Users/rykts/Documents/JANKEN/bot/StreamBot_Beta/hand.csv')

with open("C:/Users/rykts/Documents/JANKEN/bot/StreamBot_Beta/hand.csv", 'a', newline='')as f:
    writer = csv.writer(f)
...
def randomJanken():
    ...
    for _ in range(10):
        ...
        hands[3] = your_hand_now
        # csvファイルに書き込み
        with open('C:/Users/rykts/Documents/JANKEN/bot/StreamBot_Beta/hand.csv', 'a', newline='\n') as csvFile:
            writer = csv.writer(csvFile)
